    ...
    <div class="page-content">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0 font-size-18">List Validasi Pengajuan Cuti</h4>
                    </div>
                </div>
            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-sm btn-warning btn-block"
                                                        data-toggle="modal"
                                                        data-target="#modal{{ $row->id }}">Validasi</button>
                                                </td>
                                            </tr>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="{{ route('validasi.update', $row->id) }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('PUT')
                                                                ...
                                                                <div class="form-group form-row align-items-center">
                                                                    <div class="col-lg-6">
                                                                        ...
                                                                        <input type="date" class="form-control"
                                                                            id="dari_tanggal" name="dari_tanggal" readonly
                                                                            value="{{ $row->pengajuan->dari_tanggal }}"
                                                                            required>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        ...
                                                                        <input type="date" class="form-control"
                                                                            id="ke_tanggal" name="ke_tanggal"
                                                                            value="{{ $row->pengajuan->ke_tanggal }}"
                                                                            readonly>
                                                                    </div>
                                                                </div>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0 font-size-18">List Histori Validasi Pengajuan Cuti</h4>
                    </div>
                </div>
            </div>
    ...
    @foreach ($histori as $row)
        <div class="modal fade" id="modal{{ $row->id }}">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Histori Validasi Pengajuan</h4>
